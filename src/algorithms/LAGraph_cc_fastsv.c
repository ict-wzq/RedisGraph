...
static GrB_Info Reduce_assign (GrB_Vector w, GrB_Vector src, GrB_Index *index, GrB_Index nLocs)
{
    ...
    GrB_Index *mem = (GrB_Index*)rm_malloc(sizeof(GrB_Index) * nw * 3);
...
)
{
    ...
    // temporary arrays
    GrB_Index *I = rm_malloc(sizeof(GrB_Index) * n);
    GrB_Index *V = rm_malloc(sizeof(GrB_Index) * n);
    // prepare vectors
